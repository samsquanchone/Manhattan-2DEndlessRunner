...
public enum PoolingObjectType { Astroid1, Astroid2, Astroid3, Wormhole, Bullet, SpeedPickUp, HealthPickUp, WormHolePickUp,WhiteHolePickUp, EnemyBullet, Enemy, ShieldPickup, Enemy2, MeleeEnemy, Astroid4, Astroid5};
